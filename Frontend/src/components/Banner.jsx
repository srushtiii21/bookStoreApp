...
function Banner() {
  return (
    ...
    <h1 className="text-4xl font-bold">Hello, welcomes here to learn something {" "}<span className="text-pink-500">new everyday!!!</span></h1>
        <p className="text-xl">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolor, et totam. Tepora 
        amet atque expedita, quae corrupti totam sed pariatur corporis at veniam state
        volupta animi!
            </p>
